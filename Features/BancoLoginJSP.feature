Feature: Realizacion de casos ingresando nombre de usuario y contraseña
  ...
  Scenario: Ingresar nombre de usuario y contraseña correctos.
    Given Abrir Chrome
    When el usuario ingresa Username "jessica" y Password "12345" correctos.
  ...
  Scenario: Ingresar nombre de usuario y contraseña incorrecto.
    Given Abrir Chrome
    When el usuario ingresa ingresa Username "usermal" y Password "passworderror" incorrectos
